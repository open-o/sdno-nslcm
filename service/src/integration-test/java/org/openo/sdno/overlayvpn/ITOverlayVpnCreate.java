...
import org.openo.sdno.overlayvpn.mocoserver.OSDriverMocoServer;
...
public class ITOverlayVpnCreate extends TestManager {
    ...
    private OSDriverMocoServer openStackServer = new OSDriverMocoServer(12308);
