...
import org.openo.sdno.nslcm.mocoserver.underlayvpn.L3VpnMocoServer;
...
public class L3VpnSuccessTest extends TestManager {
    ...
    private static final String INSTANTIATE_L3VPN_INSTANCE_TESTCASE =
            "src/integration-test/resources/testcase/instantiatel3vpnnsinstance.json";

    private static final String TERMINATE_L3VPN_INSTANCE_TESTCASE =
            "src/integration-test/resources/testcase/terminatel3vpnnsinstance.json";
    ...
    private static L3VpnMocoServer sbiAdapterServer = new L3VpnMocoServer();
    ...
    @Test
    public void l3VpnSuccessTest() throws ServiceException {
        ...
        HttpRquestResponse httpInstantiateNsInstanceObject =
                HttpModelUtils.praseHttpRquestResponseFromFile(INSTANTIATE_L3VPN_INSTANCE_TESTCASE);
        ...
        HttpRquestResponse httpTerminateNsInstanceObject =
                HttpModelUtils.praseHttpRquestResponseFromFile(TERMINATE_L3VPN_INSTANCE_TESTCASE);
