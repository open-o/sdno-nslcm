...
import org.openo.sdno.nslcm.mocoserver.MocoOverlaySuccessServer;
...
public class ITOverlaySuccess extends TestManager {

    private static MocoOverlaySuccessServer sbiAdapterServer = new MocoOverlaySuccessServer();
