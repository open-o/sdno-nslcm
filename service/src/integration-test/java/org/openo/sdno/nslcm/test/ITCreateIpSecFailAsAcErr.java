...
import org.openo.sdno.ipsecservice.mocoserver.SbiAdapterCreateIpSecFailInAcServer;
...
public class ITCreateIpSecFailAsAcErr extends TestManager {

    private static SbiAdapterCreateIpSecFailInAcServer sbiAdapterServer = new SbiAdapterCreateIpSecFailInAcServer();
    ...
    @Test
    public void testCreateIpSecFailAsAdapterRsp500() throws ServiceException {
        try {
            // test create
    ...
    @Test
    public void testCreateIpSecFailAsAdapterRsp404() throws ServiceException {
        try {
            status = 404;
            sbiAdapterServer.setCreateErrStatus(status);
