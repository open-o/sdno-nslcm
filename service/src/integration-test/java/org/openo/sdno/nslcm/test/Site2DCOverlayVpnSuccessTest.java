...
public class Site2DCOverlayVpnSuccessTest extends TestManager {
    ...
    private static final String INIT_SITE2DC_IPSEC_NS_TESTCASE =
            "src/integration-test/resources/testcase/initsite2dcipsecns.json";

    private static final String INIT_SITE2DC_MPLS_NS_TESTCASE =
            "src/integration-test/resources/testcase/initsite2dcmplsns.json";
    ...
    @Test
    public void site2DCIpSecSuccessTest() throws ServiceException {
        overlayVpnSuccessTest(INIT_SITE2DC_IPSEC_NS_TESTCASE);
    }

    @Test
    public void site2DCMPLSSuccessTest() throws ServiceException {
        overlayVpnSuccessTest(INIT_SITE2DC_MPLS_NS_TESTCASE);
    }

    public void overlayVpnSuccessTest(String vpnTestCase) throws ServiceException {
        ...
        HttpRquestResponse httpInstantiateNsInstanceObject =
                HttpModelUtils.praseHttpRquestResponseFromFile(vpnTestCase);
