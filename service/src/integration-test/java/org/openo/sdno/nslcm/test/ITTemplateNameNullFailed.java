...
import org.openo.sdno.nslcm.mocoserver.MocoTemplateNameNull;
...
public class ITTemplateNameNullFailed extends TestManager {

    private static MocoTemplateNameNull sbiAdapterServer = new MocoTemplateNameNull();
