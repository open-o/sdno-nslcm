...
import org.openo.sdno.ipsecservice.mocoserver.SbiAdapterDeleteIpSecFailInAcServer;
...
public class ITDeleteIpSecfailAsAcErr extends TestManager {
    ...
    SbiAdapterDeleteIpSecFailInAcServer sbiAdapterServer2 = new SbiAdapterDeleteIpSecFailInAcServer();
    ...
    public void testOperateIpSecSuccess() throws ServiceException {
        try {
            ...
            // test delete fail
            sbiAdapterServer2 = new SbiAdapterDeleteIpSecFailInAcServer();
